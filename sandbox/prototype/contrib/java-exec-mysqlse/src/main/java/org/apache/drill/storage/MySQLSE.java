...
public class MySQLSE extends AbstractStorageEngine implements StorageEngine {
  @Override
  ...
  public Collection<ReadEntry> getReadEntries(Scan scan) throws IOException {
    //todo entries from logical Scan
    return super.getReadEntries(scan);
  }

  @Override
  public RecordReader getReader(FragmentContext context, ReadEntry readEntry) throws IOException {
    MySQLScanReadEntry myEntry = (MySQLScanReadEntry) readEntry;
    return new MySQLSEReader(context, myEntry);
  }
